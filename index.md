...
Архива садржи три директоријума, `doc`, `pack` и `syntax`. У `doc` директоријуму се
налазе преведени фајлови документације и фајл са ознакама, у `pack`
директоријуму преводи документације додатка који се испоручују уз едитор, а у
`syntax` директоријуму фајл help-sr.vim који садржи додатне дефиниције неопходне
за правилно истицање синтаксе у преведеним фајловима документације.
...
Ово је превод стања фајлова документације закључно са закрпом 1365 (9.1.1365)
