# Српски превод документације програма Vim 9.2
...
## HTML верзија превода документације

У фолдеру `vimhelp-sr_html` се налази HTML верзија превода комплетне
документације заједно са Vim често постављаним питањима (Vim_FAQ).
Распакујте овај фолдер на било које место на диску и отворите
својим интернет прегледачем почетну страницу `help.srx.html.`

Ово је превод стања фајлова документације закључно са закрпом 0780 (9.2.0780)

## Историја:

- верзија 4.1 (05.07.2026.) - Превод ажуриран на Vim 9.2 ниво закрпе 0780
- верзија 4.0 (11.05.2026.) - Превод ажуриран на Vim 9.2 ниво закрпе 0421
- верзија 3.9 (23.12.2025.) - Превод ажуриран на Vim 9.1 ниво закрпе 1980
- верзија 3.8 (22.08.2025.) - Превод ажуриран на Vim 9.1 ниво закрпе 1634,
испоручује се и превод Vim_FAQ
